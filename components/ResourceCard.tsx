...
export const ResourceCard: React.FC<ResourceCardProps> = ({ resource, tasks, onClick }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md hover:border-blue-300 transition-all cursor-pointer group flex flex-col h-full relative"
    >
      {/* Header */}
